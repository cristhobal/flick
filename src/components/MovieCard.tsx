      ...
      >
        ...
        >
          <div className="relative aspect-[2/3] w-full overflow-hidden bg-neutral-900">
            ...
            <div className="absolute top-2 left-2 z-10 transition-transform duration-300 group-hover/card:scale-90">
              <Badge
                variant="secondary"
                className="border-0 bg-black/60 text-[10px] text-neutral-300 backdrop-blur-sm"
              >
