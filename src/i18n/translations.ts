...
const hi: Dictionary = {
  ...
  "player.seasonEpisode": "सीज़न {season} · एपिसोड {episode}", "player.nowPlaying": "अभी चल रहा है", "player.upNext": "आगे क्या है", "player.watched": "देखा गया", "player.showMoreEpisodes": "और एपिसोड देखें", "player.showLessEpisodes": "कम देखें",
...
const zh: Dictionary = {
  ...
  "player.seasonEpisode": "第{season}季 · 第{episode}集", "player.nowPlaying": "正在播放", "player.upNext": "接下来", "player.watched": "已观看", "player.showMoreEpisodes": "查看更多集", "player.showLessEpisodes": "收起",
