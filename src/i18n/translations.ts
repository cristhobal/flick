...
const en: Dictionary = {
  ...
  "common.play": "Play", "common.details": "View details", "common.favoritesSoon": "Favorites Â· Coming soon",
  ...
  "favorites.addAction": "Add to Favorite", "favorites.activeAction": "Favorite",
  "favorites.addAria": "Add to Favorite", "favorites.removeAria": "Remove from Favorite",
  "favorites.addedTitle": "Added to Favorite", "favorites.removedTitle": "Removed from Favorite",
  "favorites.genreFallback": "No genre available",
...
const es: Dictionary = {
  ...
  "nav.favorites": "Favoritos", "nav.library": "Catálogo", "nav.main": "Navegación principal",
  ...
  "favorites.addAction": "Agregar a Favorito", "favorites.activeAction": "Favorito",
  "favorites.addAria": "Agregar a Favorito", "favorites.removeAria": "Quitar de Favorito",
  "favorites.addedTitle": "Agregado a Favorito", "favorites.removedTitle": "Quitado de Favorito",
  "favorites.genreFallback": "Sin género disponible",
...
const fr: Dictionary = {
  ...
  "nav.favorites": "Favoris", "nav.library": "BibliothÃ¨que", "nav.main": "Navigation principale",
  "common.search": "Rechercher", "common.searchContent": "Rechercher des films, sÃ©ries, anime...", "common.searchShort": "Rechercher...",
  "common.play": "Lire", "common.details": "Voir les dÃ©tails", "common.favoritesSoon": "Favoris Â· BientÃ´t",
  "common.comingSoon": "BientÃ´t", "common.availableSoon": "Disponible prochainement", "common.viewAll": "Tout voir",
  ...
  "favorites.addAction": "Ajouter aux favoris", "favorites.activeAction": "Favori",
  "favorites.addAria": "Ajouter aux favoris", "favorites.removeAria": "Retirer des favoris",
  "favorites.addedTitle": "AjoutÃ© aux favoris", "favorites.removedTitle": "RetirÃ© des favoris",
  "favorites.genreFallback": "Aucun genre disponible",
...
const hi: Dictionary = {
  ...
  "nav.favorites": "à¤ªà¤¸à¤‚à¤¦à¥€à¤¦à¤¾", "nav.library": "à¤²à¤¾à¤‡à¤¬à¥à¤°à¥‡à¤°à¥€", "nav.main": "à¤®à¥à¤–à¥à¤¯ à¤¨à¥‡à¤µà¤¿à¤—à¥‡à¤¶à¤¨",
  ...
  "common.play": "à¤šà¤²à¤¾à¤à¤", "common.details": "à¤µà¤¿à¤µà¤°à¤£ à¤¦à¥‡à¤–à¥‡à¤‚", "common.favoritesSoon": "à¤ªà¤¸à¤‚à¤¦à¥€à¤¦à¤¾ Â· à¤œà¤²à¥à¤¦",
  "common.comingSoon": "à¤œà¤²à¥à¤¦ à¤† à¤°à¤¹à¤¾ à¤¹à¥ˆ", "common.availableSoon": "à¤œà¤²à¥à¤¦ à¤‰à¤ªà¤²à¤¬à¥à¤§", "common.viewAll": "à¤¸à¤­à¥€ à¤¦à¥‡à¤–à¥‡à¤‚",
  ...
  "favorites.unavailable": "à¤ªà¤¸à¤‚à¤¦à¥€à¤¦à¤¾ à¤¸à¥à¤µà¤¿à¤§à¤¾ à¤…à¤­à¥€ à¤‰à¤ªà¤²à¤¬à¥à¤§ à¤¨à¤¹à¥€à¤‚ à¤¹à¥ˆà¥¤",
  "favorites.empty": "अभी कोई पसंदीदा नहीं है।",
  "favorites.addAction": "पसंदीदा में जोड़ें", "favorites.activeAction": "पसंदीदा",
  "favorites.addAria": "पसंदीदा में जोड़ें", "favorites.removeAria": "पसंदीदा से हटाएँ",
  "favorites.addedTitle": "पसंदीदा में जोड़ा गया", "favorites.removedTitle": "पसंदीदा से हटाया गया",
  "favorites.genreFallback": "कोई शैली उपलब्ध नहीं",
...
const zh: Dictionary = {
  ...
  "nav.favorites": "æ”¶è—", "nav.library": "åª’ä½“åº“", "nav.main": "ä¸»å¯¼èˆª",
  "common.search": "æœç´¢", "common.searchContent": "æœç´¢ç”µå½±ã€å‰§é›†ã€åŠ¨ç”»...", "common.searchShort": "æœç´¢...",
  "common.play": "æ’­æ”¾", "common.details": "æŸ¥çœ‹è¯¦æƒ…", "common.favoritesSoon": "æ”¶è— Â· å³å°†æŽ¨å‡º",
  "common.comingSoon": "å³å°†æŽ¨å‡º", "common.availableSoon": "å³å°†å¯ç”¨", "common.viewAll": "æŸ¥çœ‹å…¨éƒ¨",
  ...
  "favorites.unavailable": "æ”¶è—åŠŸèƒ½å°šæœªå¼€æ”¾ã€‚",
  "favorites.empty": "暂无收藏。",
  "favorites.addAction": "添加到收藏", "favorites.activeAction": "已收藏",
  "favorites.addAria": "添加到收藏", "favorites.removeAria": "从收藏中移除",
  "favorites.addedTitle": "已添加到收藏", "favorites.removedTitle": "已从收藏移除",
  "favorites.genreFallback": "暂无类型",
