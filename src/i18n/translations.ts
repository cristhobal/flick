...
const en: Dictionary = {
  ...
  "common.play": "Play", "common.details": "View details", "common.comingSoon": "Coming soon", "common.availableSoon": "Available soon", "common.viewAll": "View all", "common.resume": "Resume",
  ...
  "common.male": "Male", "common.female": "Female", "common.alsoKnownAs": "Also known as", "common.noInfo": "No additional information available",
  ...
  "details.expandCover": "Expand {title} cover", "details.closeCover": "Close",
  "player.trailer": "Trailer", "player.audio": "Audio", "player.subtitles": "Subtitles", "player.off": "Off",
  "player.speed": "Speed", "player.singleAudio": "Only one audio track is available", "player.episode": "Episode {episode}",
  ...
  "player.nextEpisodeIn": "Next episode in {seconds}s", "player.cancelAutoplay": "Cancel autoplay",
  "player.seasonEpisode": "Season {season} · Episode {episode}", "player.nowPlaying": "Now playing", "player.upNext": "Up next",
  "player.watched": "Watched", "player.showMoreEpisodes": "Show more episodes", "player.showLessEpisodes": "Show less",
  "player.paused": "Paused", "player.youAreWatching": "You're watching",
...
const es: Dictionary = {
  ...
  "common.play": "Reproducir", "common.details": "Ver detalles", "common.comingSoon": "Próximamente", "common.availableSoon": "Disponible próximamente", "common.viewAll": "Ver todo", "common.resume": "Reanudar",
  ...
  "common.male": "Hombre", "common.female": "Mujer", "common.alsoKnownAs": "También conocido como", "common.noInfo": "No hay información adicional disponible",
  ...
  "details.filmography": "Filmografía",
  ...
  "details.screenshots": "Capturas",
  "details.expandCover": "Ampliar carátula de {title}", "details.closeCover": "Cerrar",
  "player.trailer": "Tráiler", "player.audio": "Audio", "player.subtitles": "Subtítulos", "player.off": "Desactivados",
  "player.speed": "Velocidad", "player.singleAudio": "Solo hay una pista de audio", "player.episode": "Episodio {episode}",
  ...
  "player.nextEpisodeIn": "Siguiente capítulo en {seconds} s", "player.cancelAutoplay": "Cancelar reproducción automática",
  "player.seasonEpisode": "Temporada {season} · Episodio {episode}", "player.nowPlaying": "Reproduciendo ahora", "player.upNext": "Próximos episodios",
  "player.watched": "Visto", "player.showMoreEpisodes": "Ver más episodios", "player.showLessEpisodes": "Ver menos",
  "player.paused": "En pausa", "player.youAreWatching": "Estás viendo",
...
const fr: Dictionary = {
  ...
  "common.play": "Lire", "common.details": "Voir les dÃ©tails", "common.comingSoon": "BientÃ´t", "common.availableSoon": "Disponible prochainement", "common.viewAll": "Tout voir", "common.resume": "Reprendre",
  ...
  "common.male": "Homme", "common.female": "Femme", "common.alsoKnownAs": "Également connu sous le nom", "common.noInfo": "Aucune information supplémentaire disponible",
  ...
  "details.screenshots": "Captures d'écran",
  "player.trailer": "Bande-annonce", "player.audio": "Audio", "player.subtitles": "Sous-titres", "player.off": "DÃ©sactivÃ©s",
  "player.speed": "Vitesse", "player.singleAudio": "Une seule piste audio est disponible", "player.episode": "Ã‰pisode {episode}",
  ...
  "player.nextEpisodeIn": "Prochain épisode dans {seconds} s", "player.cancelAutoplay": "Annuler la lecture automatique",
  "player.seasonEpisode": "Saison {season} · Épisode {episode}", "player.nowPlaying": "En cours de lecture", "player.upNext": "À suivre",
  "player.watched": "Vu", "player.showMoreEpisodes": "Voir plus d'épisodes", "player.showLessEpisodes": "Voir moins",
  "player.paused": "En pause", "player.youAreWatching": "Vous regardez",
...
const hi: Dictionary = {
  ...
  "common.play": "à¤šà¤²à¤¾à¤à¤", "common.details": "à¤µà¤¿à¤µà¤°à¤£ à¤¦à¥‡à¤–à¥‡à¤‚", "common.comingSoon": "à¤œà¤²à¥à¤¦ à¤† à¤°à¤¹à¤¾ à¤¹à¥ˆ", "common.availableSoon": "à¤œà¤²à¥à¤¦ à¤‰à¤ªà¤²à¤¬à¥à¤§", "common.viewAll": "à¤¸à¤­à¥€ à¤¦à¥‡à¤–à¥‡à¤‚", "common.resume": "जारी रखें",
  ...
  "common.male": "à¤ªà¥à¤°à¥à¤·", "common.female": "à¤®à¤¹à¤¿à¤²à¤¾", "common.alsoKnownAs": "à¤‡à¤¸ à¤¨à¤¾à¤® à¤¸à¥‡ à¤­à¥€ à¤œà¤¾à¤¨à¤¾ à¤œà¤¾à¤¤à¤¾ à¤¹à¥ˆ", "common.noInfo": "à¤•à¥‹à¤ˆ à¤…à¤¤à¤¿à¤°à¤¿à¤•à¥à¤¤ à¤œà¤¾à¤¨à¤•à¤¾à¤°à¥€ à¤‰à¤ªà¤²à¤¬à¥à¤§ à¤¨à¤¹à¥€à¤‚ à¤¹à¥ˆ",
  ...
  "player.speed": "गति", "player.singleAudio": "à¤•à¥‡à¤µà¤² à¤à¤• à¤‘à¤¡à¤¿à¤¯à¥‹ à¤Ÿà¥à¤°à¥ˆà¤• à¤‰à¤ªà¤²à¤¬à¥à¤§ à¤¹à¥ˆ", "player.episode": "à¤à¤ªà¤¿à¤¸à¥‹à¤¡ {episode}",
  ...
  "player.nextEpisodeIn": "{seconds} सेकंड में अगला एपिसोड", "player.cancelAutoplay": "ऑटोप्ले रद्द करें",
  "player.seasonEpisode": "सीज़न {season} · एपिसोड {episode}", "player.nowPlaying": "अभी चल रहा है", "player.upNext": "आगे क्या है", "player.watched": "देखा गया", "player.showMoreEpisodes": "और एपिसोड देखें", "player.showLessEpisodes": "कम देखें", "player.paused": "रुका हुआ", "player.youAreWatching": "आप देख रहे हैं",
...
const zh: Dictionary = {
  ...
  "common.play": "æ’­æ”¾", "common.details": "æŸ¥çœ‹è¯¦æƒ…", "common.comingSoon": "å³å°†æŽ¨å‡º", "common.availableSoon": "å³å°†å¯ç”¨", "common.viewAll": "æŸ¥çœ‹å…¨éƒ¨", "common.resume": "继续观看",
  ...
  "common.male": "男", "common.female": "女", "common.alsoKnownAs": "又名", "common.noInfo": "没有其他可用信息",
  "home.featured": "精选内容", "home.recent": "æœ€è¿‘æ·»åŠ ", "home.continue": "ç»§ç»­è§‚çœ‹",
  ...
  "player.speed": "速度", "player.singleAudio": "ä»…æœ‰ä¸€æ¡éŸ³è½¨", "player.episode": "ç¬¬ {episode} é›†",
  ...
  "player.nextEpisodeIn": "{seconds}秒后播放下一集", "player.cancelAutoplay": "取消自动播放",
  "player.seasonEpisode": "第{season}季 · 第{episode}集", "player.nowPlaying": "正在播放", "player.upNext": "接下来", "player.watched": "已观看", "player.showMoreEpisodes": "查看更多集", "player.showLessEpisodes": "收起", "player.paused": "已暂停", "player.youAreWatching": "正在观看",
